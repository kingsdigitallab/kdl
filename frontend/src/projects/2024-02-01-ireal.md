...
feature:
    ...
    description: Illustration of a vast crowd beneath a geometric network structure
...
urls:
    ...
    - name: Project Poster URL
      url: https://github.com/kingsdigitallab/iREAL/tree/main/docs
sla:
    start: null
    end: null
draft: false
