...
departments:
  ...
  - name: Interdisciplinary Humanities
    slug: interdisciplinary-humanities
  - name: William & Mary
    slug: william-mary
...
members:
  ...
  - name: Arthur Burns
    ...
    roleName: Principal investigator
    inOrganisation:
      name: (Programme Steering Committee) FAH Department of History
      slug: programme-steering-committee-fah-department-of-history
  - name: Sarah Davis
    slug: sarah-davis
    roleName: Researcher
    inOrganisation:
